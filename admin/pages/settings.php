<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<?php $options = get_option('dcm_options'); ?>
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					...
					<label><input name="dcm_options[elem_date]" type="checkbox" value="1" <?php if (isset($options['elem_date'])) { checked('1', $options['elem_date']); } ?> /> <?php _e( 'Date', 'dc-meta-tags' ); ?> </label><br />

					<label><input name="dcm_options[elem_description]" type="checkbox" value="1" <?php if (isset($options['elem_description'])) { checked('1', $options['elem_description']); } ?> /> <?php _e( 'Description', 'dc-meta-tags' ); ?></label><br />

					<label><input name="dcm_options[elem_format]" type="checkbox" value="1" <?php if (isset($options['elem_format'])) { checked('1', $options['elem_format']); } ?> /> <?php _e( 'Format', 'dc-meta-tags' ); ?> </label><br />

					<label><input name="dcm_options[elem_identifier]" type="checkbox" value="1" <?php if (isset($options['elem_identifier'])) { checked('1', $options['elem_identifier']); } ?> /> <?php _e( 'Identifier', 'dc-meta-tags' ); ?> </label><br />

					<label><input name="dcm_options[elem_language]" type="checkbox" value="1" <?php if (isset($options['elem_language'])) { checked('1', $options['elem_language']); } ?> /> <?php _e( 'Language', 'dc-meta-tags' ); ?> <em>(<?php _e( 'Redundant with the <code>lang</code> attribute on the <code>html</code> element.', 'dc-meta-tags' ); ?>)</em></label><br />
					...
					<label><input name="dcm_options[elem_title]" type="checkbox" value="1" <?php if (isset($options['elem_title'])) { checked('1', $options['elem_title']); } ?> /> <?php _e( 'Title', 'dc-meta-tags' ); ?> </label><br />

					<label><input name="dcm_options[elem_type]" type="checkbox" value="1" <?php if (isset($options['elem_type'])) { checked('1', $options['elem_type']); } ?> /> <?php _e( 'Type', 'dc-meta-tags' ); ?> </label><br />
		...
		<table class="form-table">
			<tr>
				...
				<td>
					<input type="text" size="57" name="dcm_options[rights_url]" value="<?php echo $options['rights_url']; ?>" />
				</td>
			</tr>
		</table>
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<label><input name="dcm_options[output_html]" type="radio" value="xhtml" <?php checked('xhtml', $options['output_html']); ?> /> XHTML <span style="color:#666666;margin-left:32px;"><?php _e( 'Meta tag will look like <code>&lt;meta name="dc.Format" scheme="dcterms.imt" content="text/html" /&gt;</code>', 'dc-meta-tags' ); ?></span></label><br />

					<label><input name="dcm_options[output_html]" type="radio" value="html5" <?php checked('html5', $options['output_html']); ?> /> HTML5 <span style="color:#666666;margin-left:32px;"><?php _e( 'Meta tag will look like <code>&lt;meta name="dc.format" content="text/html" /&gt;</code>', 'dc-meta-tags' ); ?></span></label><br />

					<label><input name="dcm_options[output_html]" type="radio" value="html4" <?php checked('html4', $options['output_html']); ?> /> HTML4 <span style="color:#666666;margin-left:32px;"><?php _e( 'Meta tag will look like <code>&lt;meta name="dc.Format" scheme="dcterms.imt" content="text/html"&gt;</code>', 'dc-meta-tags' ); ?></span></label><br />
				</td>
			</tr>
		</table>
		<?php submit_button(); ?>
